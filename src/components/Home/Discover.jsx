...
const DiscoverCard = ({ card }) => {
  return (
    <div className="relative rounded-xl overflow-hidden cursor-pointer hover:scale-[1.009] delay-150 transition-transform shadow-xl">
      <img src={card.image} className="discover-img" alt="discover_image" />
