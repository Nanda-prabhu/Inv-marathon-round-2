...
const NewsCard = ({ text }) => (
  <div className="w-[320px] px-4 py-6 bg-white rounded-md news_card_shadow">
    ...
    <div className="pt-7 text-[13px] flex items-center gap-2">
      ...
      <div>
        <h1 className="font-medium">Jane Doe</h1>
        <p className="text-[#BFBFC8]">@Jane_Doe69</p>
      </div>
    </div>
  </div>
);
...
export default function Stories() {
  return (
    <section className="my-14">
      <Container>
        <div className="py-4 pb-4 px-14 h-[700px] overflow-auto bg-[#F7F7F7] flex items-center lg:flex-nowrap flex-wrap gap-1">
          <article className="lg:w-1/2 w-full lg:pb-0 pb-4 flex flex-col lg:items-start items-center lg:ml-14">
